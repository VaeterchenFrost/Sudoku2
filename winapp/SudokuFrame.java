...
//TODO Sudoku speichert auch die "Eintr�ge"
 ...
 * 		Das kann man sich free saugen und stellt eine OCR-Klasse dar. Der Klasse �bergibt man einfach einen FileName und gut is ;)
...
// TODO Suchstrings f�r die Ablage im *.jar-File als Ressource:
...
public class SudokuFrame extends JFrame {
	...
	/**
	 * @return Die Breite und H�he des Bereiches um die Sudokuanzeige (FeldAnzeigen)
	 */
	...
	SudokuFrame(String pfadName) throws Exc {
		...
		mainFrame = this;
		this.setTitle(titel);
		// Anwendung schlie�en bei Haupt-Fenster-Schlie�en l�uft nicht automatisch!
		...
		// Eigene Minimal-Gr��e setzen (auf Quadrat f�r das Ermitteln der nichtNutzbareHoehe!)
		int minGroesse = 300;
		this.setMinimumSize(new Dimension(minGroesse, minGroesse));
		// Die Components.. erhalten ihre reale Gr��e
		pack();

		SudokuFrame.toolBarLinks.aufpeppen();
		SudokuFrame.toolBarRechts.aufpeppen();
		// Die ToolBars erhalten ihre neue reale Gr��e
		pack();
	...
	public List<Image> getIconImages() {
		...
		// Allerdings bietet die Applikation nichts als Icon an f�r die Konfiguration des Symbols f�r eine Verkn�pfung.
		// Dazu m�sste laut Hinweisen das Bild z.B. mit IvanView im richtigen Format gespeichert werden.
		// N�mlich im Format eines Symbols und mit der Dateierweiterung .ico.
