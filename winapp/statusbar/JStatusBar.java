 ...
 * 
 * [main component ................. ] [secondary 0] [secondary 1] ... [secondary n]
 * 
 * Components can be any JComponent derivative, although more commonly a JLabel will be used,
 * which support both an icon and a text label.
 * 
 * @author shaines
 */
...
public class JStatusBar extends JPanel {
	...
	/**
	 * Creates a new JStatusBar with a main componennt and a list of secondary components
	 * @param mainComponent
	...
	public void init(JComponent mainComponent, List<JComponent> secondaryComponents) {
		...
		mainComponentPanel = buildPanel(mainComponent);
		add(mainComponentPanel, BorderLayout.CENTER);
	...
	/**
	 * @author Hendrick
	* @return Das Panel des linken JLabel (zum Hintergrundmalen)
	*/
	public JPanel gibMainComponentPanel() {
