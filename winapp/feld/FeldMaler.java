...
public class FeldMaler {
	 ...
	 * @param g
	 * @param dimension
	 * @param maxFontSize wenn != 0 wird die Textgr��e hierauf beschr�nkt
	 * @return
	 */
	 ...
	 * @param text
	 * @param maxFontSize Wenn > 0 wird die Textgr��e hierauf beschr�nkt. 
	 * 			(Es wird ansonsten der Text so gro� wie r hergibt gemalt.)
	 */
	 ...
	 * @param rFeld
	 * @param nZahlen
	 * @return Die Rechtecke f�r die Darstellung von nZahlen im Rechteck rectangle
