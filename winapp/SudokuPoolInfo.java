...
public class SudokuPoolInfo extends JTable {
	...
	/**
	 * @return Die Anzahl der Zeit-Intervalle, f�r die eine Sudokuanzahl genannt werden soll.
	 */
	...
	static private void zeige(String titel, SudokuPoolInfo table) {
		// Diese Variante bringt gr��eren Text nicht komplett auf's Trapez:
