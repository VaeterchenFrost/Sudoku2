	...
	public ToolBarRechts(SudokuBedienung aSudoku, StatusBar aStatusBar, Container container) {
		...
		// Protokoll
		{
			erschaffeGruppenTitel(" Rec ",
					"Im (auch teilweise) gel�sten Sudoku kann durch die Vergangenheit gegangen werden.");
			this.addSeparator();
			...
			bProtokollPlusSchritt.setToolTipText(gibProtokollToolTip("Gehe einen Protokoll-Schritt vorw�rts"));
