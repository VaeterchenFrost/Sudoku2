...
public class TipAnzeige extends JFrame implements ActionListener {
	...
	/**
	 * @param richtung >0 Sudoku vergr��ern, <0 verkleinern (also mehr Sudokus zeigen)
	...
	private void stelleAufAnzeigeAusschnitt() {
		...
		// Deshalb: erst alle neuen Sudoku-Anzeigen hinzuf�gen vor dem l�schen der alten:
		// N�tzte leider auch nichts! Aber setMinimumSize!!!
