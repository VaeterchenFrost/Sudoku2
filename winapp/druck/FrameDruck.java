 ...
 * nur noch ein unbenutztes Beispiel f�r den Druck eines java.Frame !
 */
public class FrameDruck implements SudokuListe {
	// Ist true nur w�hrend des Druckens des Frames
	...
	public void maleSudoku(int sudokuIndex, Graphics g, Dimension d) {
		...
		try {
			...
			// F�r die spezielle Malerei w�hrend des Druckens:
