...
public class FeldListe extends ArrayList<Feld> {
	...
	// /**
	// * @return Eine Zeilen-Nummer zur�ck wenn alle Felder in derselben Zeile liegen, sonst 0
	// */
	...
	//
	// /**
	// * @return Eine Spalten-Nummer zur�ck wenn alle Felder in derselben Spalte liegen, sonst 0
	// */
	...
	// * @return Die Anzahl freier Felder mit (nur) einer m�glichen Zahl
	// */
	...
	//
	// /**
	// * @return null oder das erste (beste) freie Feld mit (nur) 1 m�glichen Zahl
	// */
	...
	/**
	 * @param ebene
	 * @return Die Eintr�ge der Ebene. Die Liste kann leer sein. 
	 */
	...
	/**
	 * @param moegliche Die neuen m�glichen Zahlen
	...
	/**
	 * @param zahl
	 * @return Die Felder, die diese Zahl als m�gliche enthalten. 
	 * Achtung: Die R�ckgabeliste kann leer sein.
	 */
	...
	/**
	 * @param zahl
	 * @param minAnzahlMoeglicheImFeld soviel m�gliche Zahlen 
	 * 						m�ssen sich mindestens in einem genannten Feld befinden.
	 * @return Die Felder, die diese Zahl als m�gliche enthalten. 
	 * Achtung: Die R�ckgabeliste kann leer sein.
	 */
	private FeldListe gibFelderDerMoeglichenZahl(int zahl, int minAnzahlMoeglicheImFeld) {
		...
		// F�r diese Zahl die m�glichen Felder auflisten
		for (int i = 0; i < this.size(); i++) {
			Feld feld = this.get(i);
	 ...
	 * @param minAnzahlMoeglicheImFeld soviel m�gliche Zahlen 
	 * 						m�ssen sich mindestens in einem genannten Feld befinden.
	 * @return Die m�glichen Felder je Zahl (1 bis 9).
	 */
	public ZahlenFeldNummern gibFelderJeMoeglicheZahl(int minAnzahlMoeglicheImFeld) {
		...
		// F�r jede Zahl die m�glichen Felder auflisten
	...
	/**
	 * @return Alle in meinen Feldern vorhandenen Zahlen (Vorgaben, Eintr�ge, M�gliche)
	 */
	...
	/**
	 * @return Alle in meinen Feldern vorhandenen Vorgaben und Eintr�ge
	 */
