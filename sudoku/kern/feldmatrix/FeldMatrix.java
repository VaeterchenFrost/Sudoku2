...
public class FeldMatrix {
	...
	/**
	 * Ist die minimale Vorbereitung f�r Mehrfachsudoku: 
	 * Offset wird schon bei Anzeigen ber�cksichtigt.
	 */
	...
	/**
	 * @return F�r alle Felder die Vorgabe: Felder ohne Vorgabe kommen mit "0" zur�ck.
	 */
	 ...
	 * @param vorgaben InfoSudoku: Es werden nur seine Vorgaben �bernommen
	...
	/**
	 * Ver�ndert das Sudoku durch (unkritisches) Bewegen der Vorgaben, z.B. Drehen des Sudoku.
	 * Diese einfache Implementation ist nur m�glich ohne Eintr�ge, denn sie tr�gt einfach die Vorgaben hin und her!
	 * Eine Implementation mit Eintr�gen muss jeweils den gesamten FeldInhalt tauschen...
	 * @param animator
	 * @throws Exc U.a. wenn Eintr�ge existieren
	 */
	...
	/**
	 * @param zahlen Setzt diese unbeingt als M�gliche
	 */
	 ...
	 * Es ist zu beachten, dass in dem Falle, dass mehr als diese eine Zahl m�glich sind,
	 * eine neue Eintrags-Ebene er�ffnet wird!
	 * Wenn das nicht erw�nscht ist: Zuvor feld.setzeMoeglichEinzig(zahl) rufen. 
	 * @param eintrag
	...
	/**
	 * Setzt den Eintrag. 
	 * Zuvor werden die M�glichen des Feldes auf die Zahl gesetzt, 
