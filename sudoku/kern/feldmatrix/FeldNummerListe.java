...
public class FeldNummerListe extends ArrayList<FeldNummer> {
	...
	/**
	 * @param felder Alle diese Feldnummern f�ge ich zu mir hinzu.
	 */
	...
	/**
	 * @param andere
	 * @return true wenn diese Liste und die andere gleiche L�nge und gleiche Elemente besitzen.
	 * 							Die Elemente d�rfen in unterschiedlicher Reihenfolge stehen
	 */
