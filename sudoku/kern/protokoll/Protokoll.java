 ...
 * - In dem Mitgeschriebenen besteht dann die M�glichkeit sich schrittweise vor bzw. zur�ck zu bewegen.
 * - Es besteht die M�glichkeit, auf Protokollpunkte eine Markierung zu setzen 
 * 		und sp�ter das Protokoll auf diesen Punkt zur�ckgehen zu lassen.
 */
public class Protokoll implements ProtokollSchreiber, ProtokollMarkierer {
	...
	/**
	 * Ist nicht n�tig zum restaurieren eines Eintrags (spezielle Methode Feld.setzeEintragObjekt()).
	 * Aber f�r das restaurieren des Auffrischens! 
	 */
	...
	private void geheVorwaerts(Schrittweite schrittweite) throws Exc {
		...
		case VERSUCH:
			...
			// Die Vergleichsebene ist die des N�chsten Eintrags, denn es soll ja vorw�rts gehen!
	...
	public void protokolliere(FeldNummer feldNummer, Eintrag eintragAlt, Eintrag eintragNeu) {
		...
		// Wenn das L�schen auf Feldern, die gar keinen Eintrag besitzen durchgef�hrt werden darf:
		// Ben�tigen wir hier dies if.. ,
		// denn ich ben�tige immer eine FeldInfo mit Eintrag zum Ermitteln der Ebene
	...
	public ProtokollKursorInfo gibKursorInfo() throws Exc {
		...
		// min=0: Das hei�t, dass keine (eben 0) Eintr�ge vorhanden sind
	...
	public void printout() {
		...
		String sLoeschen = String.format("gel�scht:%s", sLeer);
