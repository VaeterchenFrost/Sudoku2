...
class Generator extends Generator1 {
	...
	/**
	 * @param feldMatrix In diesen Feldern wird gel�scht
	 * @param vorgaben Aus diesen Feldern sollen anzahl Felder gel�scht werden
	 * @param anzahl zu l�schender Vorgaben. Gilt auch bei symmetrierer != null.
	 * @param symmetrierer Falls != null soll das Sudoku symmetrisch aussehen.
	 * 					In diesem Fall sollte die Anzahl gerade sein: 
	 * 					Es werden jetzt jeweils 2 symmetrisch zueinander liegende Vorgaben gel�scht. 
	...
	/**
	 * @param feldMatrix In einem dieser Felder wird gel�scht. 
	 * @param vorgaben Aus diesen Feldern soll 1 Vorgabe gel�scht werden
	 * @param symmetrierer Falls != null soll das Sudoku symmetrisch aussehen. 
	 * 					In diesem Fall werden 2 Vorgaben gel�scht, falls noch 2 Vorgaben zur Verf�gung stehen! 
	...
	public class GeneratorErgebnis {
		 ...
		 * @param neuTyp Der Typ des erstellten Sudoku. Er muss nicht mit dem angeforderten Typ �bereinstimmen!
		 * @param loesungsZeit
	 ...
	 * 					ansonsten gesetzte Felder, die im weiteren nicht gel�scht werden d�rfen
	 * 					(ansonsten w�rde man die lineare L�sung wieder verlassen werden) 
	 * @throws Exc
	 */
	private FeldNummerListe sichereLineareLoesung(InfoSudoku loesung, Klugheit klugheit, Animator symmetrierer)
		...
		do {
			...
			if (ebeneNr > 1) {
				// Die Versuch-Starts wieder als Vorgaben setzen, so dass keine Versuche mehr n�tig sind
	...
	/**
	 * L�scht aus den verbliebenen Vorgaben soweit m�glich.
	 * Als erstes  wird die H�rde entsprechend NeuTyp.Klugheit eingebaut.
	 * @param tabu Vorgaben, die nicht gel�scht werden d�rfen, um die eindeutige L�sung (ohne Versuche) nicht zu verlassen
	 * @param symmetrierer Falls != null soll das Sudoku symmetrisch aussehen 
	...
	private GeneratorErgebnis gibNeues(Animator symmetrierer) {
		...
		try {
			// gew�nschte einzusetzende Klugheit wird nicht jedesmal zuf�llig erreicht
			...
			for (laufNummer = 1; laufNummer < laufNummerMax; laufNummer++) {
				...
				// Das Protokoll muss allerdings nach der wilden L�scherei der Vorgaben..
				...
				if (istGefuellt) {
					...
					// 2. Aus dem vollst�ndig mit Vorgaben gef�llten Sudoku Vorgaben entfernen
					// 2. a) gro�er Schwung bis die Eindeutigkeit infrage gestellt ist
					...
					if (tabu != null) {
						// 2. c) M�glichst weit leeren von Vorgaben: Einzelne Felder l�schen
