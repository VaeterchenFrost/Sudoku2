...
class DateiPoolInfo {
	...
	/**
	 * @return Alle Entnahmen aus dem Pool zeitlich geordnet: Auf Index 0 die �ltesten 
	 */
	 ...
	 * @return Die Zeit-Intervalle �ber alle Dateien
	 */
	 ...
	 * @param anzahlen In diesem Array der Anzahlen soll eine Anzahl um 1 erh�ht werden.
	 * @param intervalle In einem der Intervalle liegt die Datei-Zeit. Sein Index ist derjenige, der bestimmt welche Anzahl erh�ht wird.
	 */
