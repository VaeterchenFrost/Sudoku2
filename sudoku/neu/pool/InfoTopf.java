...
public class InfoTopf extends Info {
	...
	/**
	 * @return F�llstand des Topfes in % der max. m�glichen Anzahl Sudokus in diesem Topfe
	 */
	...
	/**
	 * @return F�llstand der Basis-Sudokus des Topfes in % der max. m�glichen Anzahl Bais-Sudokus in diesem Topfe
	 */
	...
	/**
	 * @return F�llstand der Doppel-Sudokus des Topfes in % der max. m�glichen Anzahl Basis-Sudokus in diesem Topfe
	 */
	...
	/**
	 * @param topf2 F�gt die Werte der Info2 zu meinen dazu. Meine AblageVorschrift bleibt unver�ndert.
	 */
