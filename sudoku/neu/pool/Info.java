...
public class Info {
	/**
	 * @param dateiZeit
	 * @return Das Datum der �bergebenen (Datei-)Zeit. Genauer gesagt: LocalDateTime mit allen Zeitangaben == 0.
	 */
	...
	/**
	 * @param dateiZeit
	 * @return Datum und Zeit Sekunden-genau der �bergebenen (Datei-)Zeit. 
	 */
	...
	// ===============================================================
	/**
	 * Anzahl aller Sudokus, die diese Info repr�sentiert
	 */
	private int anzahl;
	/**
	 * Gr��e auf Datetr�ger aller Sudokus, die diese Info repr�sentiert
	 */
	private long groesse;
	/**
	 * L�sungszeit des leichtesten Sudoku
	 */
	private Integer leichtestes;
	/**
	 * L�sungszeit des schwersten Sudoku
	 */
	...
	/**
	 * @param info2 F�gt die Werte der Info2 zu meinen dazu. 
	 */
