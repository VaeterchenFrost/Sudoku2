...
public class DateiPoolEntnahmeProtokoll {
	...
	/** Gr��te Anzahl der Sudokus im Speicher
	 */
	...
	/**
	 * @param dateiName vollst�ndiger Pfad
	 * @return Die im dateiNamen dokumentierte Zeit der �bernahme des Sudoku in das Entnahmeprotokoll
	 */
	 ...
	 * @param loesungsZeit Das Sudoku der Datei soll diese L�sungszeit besitzen.
	 * 					Falls null �bergeben wird, bleibt die L�sungszeit unber�cksichtigt.
	 * @return
	 */
