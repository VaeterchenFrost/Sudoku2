...
public class SudokuBedienung {
	...
	/**
	 * Versucht das Sudoku zu knacken (zu l�sen).
	...
	public void knacke() {
		...
		try {
			...
			if (ergebnis.gibArt() == Ergebnis.Art.FERTIG) {
				...
				// Folgende auffrischen() sollen nicht ein vom Automaten genanntes Problem zerst�ren:
	...
	*/
	...
	/**
	 * L��t die Sudoku-Logik.setzeMoegliche() laufen.
	...
	*/
	public void setzeTip(TipBericht tipBericht) {
		...
		try {
			...
			auffrischen(false);
			// Die Tip-Erstellung hinterl��t leider irgendwas untypisches. Deshalb hier hinterher nochmal der Standard:
