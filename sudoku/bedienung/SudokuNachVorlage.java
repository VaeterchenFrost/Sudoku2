 ...
 * Das kann nat�rlich eventuell dauern... Deshalb l�uft die Sudoku-Erstellung im Thread mit FortschrittAnzeige
 */
class SudokuNachVorlage implements LangerProzess {
	...
	public void prozess(FortschrittZeiger fortschrittZeiger) {
		...
		for (nLauf = ersterLauf; nLauf <= letzterLauf; nLauf++) {
			...
			// systemOut(String.format("SudokuBedienung.gibNeuesNachVorlage(): %d L�ufe", nLauf));
