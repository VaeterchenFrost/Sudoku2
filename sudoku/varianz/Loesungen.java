...
/**
 * @author heroe
 * Die Gesamtheit der L�sungen des Sudoku
 */
public class Loesungen {
	...
	/**
	 * @return F�r jede L�sung in loesungen den Index des Basis-Sudokus f�r einen Vergleich.
	 * 					Der Index im R�ckgabe-Array entspricht genau denen der loesungen.
	 * 					Der BasisIndex f�r Loesung[0] ist null!!
	 */
		...
		for (int iLoesung = 0; iLoesung < this.loesungen.size(); iLoesung++) {
			...
			default: // Es ist wirklich ein Basis-Sudoku zu suchen
				...
				for (int nStarts = versuchStarts.gibAnzahl() - 1; nStarts > 0; nStarts--) {
					// Mit allen L�sungen vor loesung
			...
			if (istSystemOut) {
				...
				System.out.println(String.format("L�sung %2d %s", iLoesung, sBasis));
			}
	...
	/**
	 * @return F�r jede L�sung in loesungen das Sudoku.
	 * 					Der Index im R�ckgabe-Array entspricht genau dem der loesungen.
	...
	/**
	 * @return F�r jede L�sung in loesungen das Basis-Sudoku
	 * 					Der Index im R�ckgabe-Array entspricht genau dem der loesungen.
	 */
