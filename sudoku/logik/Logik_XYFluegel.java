...
class Logik_XYFluegel implements Logik__Interface {
	...
	private class TipInfoXYFluegel extends TipInfo0 {
		...
		public EinTipText[] gibTip() {
			...
			String s1a = "In den 3 verkn�pften Feldern " + zahlenFeldNummern.gibKette("+");
			String s1b = " sind insgesamt nur 3 Zahlen m�glich.";
			...
			String s3 = String.format("Feld%s %s und %s verkn�pft beide Gruppen.", verbindungsFeld,
			...
			String s5 = String.format("Die Zahl %d ist daher %s %s nicht m�glich.", loeschZahl, s5a,
	...
	@Override
	public String[] gibWo() {
		return new String[] { "Nur Felder mit 2 m�glichen Zahlen.", "3 Felder mit insgesamt 3 m�glichen Zahlen.",
				"Jede m�gliche Zahl tritt innerhalb der 3 Felder genau zweimal auf.",
				"3 Felder: 2 Felder davon auf 1er Zeile bzw. Spalte, 2 Felder davon in einer verkn�pften Gruppe." };
	}
	...
	public String[] gibSituation() {
		return new String[] { "Die gemeinsame m�gliche Zahl der beiden nicht verkn�pfenden Felder",
	...
	public String[] gibErgebnis() {
		return new String[] {
				"Im Kreuzungsfeld der nicht verkn�pfenden Felder ist deren gemeinsame Zahl nicht m�glich.",
				"In dem Fall, die verkn�pfte Gruppe ist ein Kasten, ist diese Zahl au�erdem nicht m�glich:",
				" - im Kasten auf der Linie des Verkn�pfungsfeldes",
	...
	// =============================================================
	/**
	 * @param linien Ihre Arbeitsfelder werden gesetzt mit den Feldern, die 2 m�gliche Zahlen besitzen
	 */
	...
	/**
	 * @param kastenMap Ihre Arbeitsfelder werden gesetzt mit den Feldern, die 2 m�gliche Zahlen besitzen
	 */
	 ...
	 * @param feld1
	 * @param feld2
	 * @return != null falls die beiden Felder feld1 und feld2 gemeinsam 3 m�gliche Zahlen beinhalten. 
	 * 					In diesem Fall werden die beiden m�glichen Zahlen zur�ckgegeben, 
	 * 					die das dritte zu suchende Feld besitzen muss f�r diese Logik. 
	 * 					Die Reihenfolge der m�glichen Zahlen in der R�ckgabeliste entspricht der von BasisLogik.setzeMoegliche(),
	 * 					um einen direkten Vergleich der m�glichen Zahlen per ...equals() zu erm�glichen.
	 */
	static private ArrayList<Integer> gibFehlendeMoeglicheZahlen(Feld feld1, Feld feld2) {
		...
		// aufsteigende Sortierung der m�glichen Zahlen garantieren:
	...
	/**
	 * Es wird vorausgesetzt, dass die beiden Felder insgesamt 3 m�gliche Zahlen beinhalten, jedes Feld 2 davon. 
	 * @param feld1
	 * @param feld2
	 * @return Die in den beiden Feldern gemeinsame m�gliche Zahl. 
	 */
	...
	/**
	 * @param loeschZahl Die m�gliche Zahl, die zu l�schen w�re.
	 * @param feld Dies Feld soll von der Betrachtung ausgeschlossen werden. Kann auch null �bergeben worden sein. 
	 * @param basisLinie Die Felder dieser Gruppe, die auch im kasten liegen, sollen betrachtet werden.
	 * @param kasten
	 * @return Leere Liste oder die Nummern der betrachteten Felder, die die loeschZahl als m�gliche Zahl enthalten.
	 */
	...
	/**
	 * @param loeschZahl Die m�gliche Zahl, die in dieser Konstellation zu l�schen w�re.
	 ...
	 * @return Die Nummern der Felder, in denen die m�gliche Zahl <loeschZahl> zu l�schen ist (oder leere Liste).
	 * 					Das sind maximal:
	 * 						a) Die Felder, die sowohl auf der BasisLinie als auch im Kasten13 liegen au�er feld1.
	...
	/**
	 * @param loeschZahl Die m�gliche Zahl, die in dieser Konstellation zu l�schen w�re.
	 * 					Das Feld des Kreuzungspunktes der beiden Felder feld1 und feld2 kann eventuell das L�schfeld sein.
	 * @param feld1 
	 * @param feld2 Dieses Feld liegt auf einer anderen linie als das feld1
	 * @param linien Die Arbeitslinien, in denen auch das L�sch-Feld zu finden ist.
	 * @return null oder die Nummer des Feldes, in dem die m�gliche Zahl <loeschZahl> zu l�schen ist.
	 * 					null kommt zur�ck, wenn die <loeschZahl> nicht als m�gliche Zahl in dem Feld des Kreuzungspunktes der beiden Felder existiert.
	 */
	 ...
	 * 					und dadurch zu l�schende m�gliche Zahlen erkannt wurden. 
	 */
			...
			if (arbeitsFelder.size() > 0) {
				for (int iArbeitsFelder = 0; iArbeitsFelder < arbeitsFelder.size(); iArbeitsFelder++) {
					...
					if (fehlendeMoeglicheZahlen.equals(testMoegliche)) {
						// Das sieht schon mal gut aus: Die M�glichen des Arbeitsfeldes stimmen.
	 ...
	 * @param basisLinien Benennen die Arbeitsfelder: Jedes der Felder besitzt 2 m�gliche Zahlen.
	 * @param kastenMap Die K�sten greifbar �ber ihren Kasten-Index.
			...
			if (basisLinie != null) {
				if (basisLinie.arbeitsFelder != null) {
					if (basisLinie.arbeitsFelder.size() > 1) {
						// Die Basis-Linie besitzt mindestens 2 Felder mit 2 m�glichen Zahlen.
						...
						for (int iArbeitsFeld = 0; iArbeitsFeld < basisLinie.arbeitsFelder.size() - 1; iArbeitsFeld++) {
							...
							for (int iTestFeld = 0; iTestFeld < basisLinie.arbeitsFelder.size(); iTestFeld++) {
								...
								if (!arbeitsFeldKastenIndex.equals(testFeldKastenIndex)) {
									// arbeitsFeld und TestFeld liegen in unterschiedlichen K�sten
									ArrayList<Integer> fehlendeMoeglicheZahlen = gibFehlendeMoeglicheZahlen(arbeitsFeld,
											testFeld);
									if (fehlendeMoeglicheZahlen != null) {
										// Arbeits- und Test-Feld besitzen zusammen genau 3 m�gliche Zahlen.
