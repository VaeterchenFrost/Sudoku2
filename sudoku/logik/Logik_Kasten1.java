...
class Logik_Kasten1 extends LogikKastenN {
	...
	public String[] gibErgebnis() {
		return new String[] { "Im Kasten wird die Zahl auf dieser 1 Linie aus den m�glichen dieser Felder gel�scht." };
	}
	...
	/**
	 * Wenn hier im Kasten eine m�gliche Zahl auf mehreren Spalten / Zeilen steht:
	 * Bezug auf die m�glichen Zahlen jeweils eines Nachbar-Kastens: 
	 * Erkenne m�gliche Zahl auf nur einer seiner Zeile bzw. Spalte: 
	 * Im Kasten wird diese Zahl hier gel�scht.
		...
		for (int iNachbar = 0; iNachbar < linienDerNachbarn.size(); iNachbar++) {
			...
			if (nMeineLinien > 1) {
				...
				if (1 == iNachbarLinienDerZahl.size()) {
					...
					// In jeder Logik, die m�gliche Zahlen l�scht, kann der Fall eintreten,
					// dass dies Feld nach dem L�schen nur noch eine m�gliche Zahl hat.
					// Aber diese m�gliche Solo-Zahl muss schon wirklich eine andere Logik erkennen!
