...
abstract class LogikKastenN implements Logik__Interface {
	...
	private class TipInfoKasten extends TipInfo0 {
		 ...
		 * @param textInGruppe beschreibt den Kasten in dem m�gliche Zahlen gel�scht wurden
		 * @param ergebnis
		 * @param infoSudoku
		 */
		...
		private ArrayList<EinTipText> gibTipKasten2(KastenErgebnis ergebnis1) {
			...
			String s1a = String.format("%s wird die %d gel�scht", this.textInGruppe, ergebnis1.gibLoeschZahl());
			...
			String s2b = String.format("ben�tigen die %d %s %s.", ergebnis1.gibLoeschZahl(), inText, sLinien);
	 ...
	 * @return Wenn die Logik erfolgreich gelaufen ist, d.h. L�sch-Zahlen erkannt wurden, dies Ergebnis, sonst null
	 */
