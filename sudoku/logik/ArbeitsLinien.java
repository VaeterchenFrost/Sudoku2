...
class ArbeitsLinien {
	...
	class Linie {
		/**
		 * Die Gruppe, zu denen die Felder geh�ren: Hier k�nnen die Gruppen-Infos abgefragt werden.
		 */
		Gruppe gruppe;
		/**
		...
		/**
		 * Setzt die Felder der Gruppe, die speziell f�r diese Linie greifbar sein sollen.
		 * @param feldListe
		 */
	 ...
	 * 					Das Feld der feldnummer selbst befindet sich nicht in der R�ckgabe-Feldliste.
	 * 					Die R�ckgabe-Feldliste kann leer sein .
	 */
