...
abstract class LogikFeldPaareRing implements Logik__Interface {
	...
	/**
	 * Diese Logik wird nur im TipInfo ben�tigt. Sie steht deshalb hier, weil die interne Klasse keine statischen Methoden besitzen kann. 
	 * @param linien
	 * @param senkrechte
	 ...
	 * @return Eine neue Instanz f�r feldNummer mit Zeile bzw. Spalte gleich 0.
	 ...
	 * @return Die zum L�schen vorgeschlagenen Zahlen oder null wenn es keine solche gibt.
	 */
	...
	/**
	 * @param ringInfo Alle n�tigen Infos zum bereits erkannten noch unvollst�ndigen Ring.
	 ...
	 * @return Alle m�glichen Kombinationen der FeldPaare, die einen Ring bilden k�nnten.
	...
	public String[] gibErgebnis() {
		return new String[] {
				"Au�er in den betrachteten Feldern kann die m�gliche Zahl in den betreffenden Spalten gel�scht werden." };
	}
	...
	/**
	 * @param gruppenLaeufeListe Die ist mitzuschreiben (f�r die Zeitermittlung)
	 * @param linien Die Zeilen bzw. Spalten, die auf FeldPaare (Genau 2 Felder mit 1 m�glichen Zahl in der Gruppe) zu testen sind
