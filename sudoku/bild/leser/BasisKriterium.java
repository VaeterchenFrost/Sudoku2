...
class BasisKriterium {
	...
	static public KriteriumBildInfo grosserKreisOben9() {
		return new KriteriumFelder("Groﬂer Kreis oben", schwarzAb80, new FeldNummer[] { new FeldNummer(2, 1),
	...
	static public KriteriumBildInfo grosserKreisUnten68() {
		return new KriteriumFelder("Groﬂer Kreis unten", schwarzAb80, new FeldNummer[] { new FeldNummer(2, 3),
	...
	static public KriteriumBildInfo grosserKreisUntenOffen35() {
		return new KriteriumFelder("Groﬂer Kreis unten offen", schwarzAb80, new FeldNummer[] { new FeldNummer(4, 3),
	...
	static public KriteriumBildInfo grosserHalbkreisOben26() {
		return new KriteriumFelder("Groﬂer Halbkreis oben", schwarzAb80, new FeldNummer[] { new FeldNummer(2, 1),
				new FeldNummer(3, 1), new FeldNummer(4, 1), new FeldNummer(5, 1), new FeldNummer(1, 2),
				new FeldNummer(6, 2) });
	}
	...
	static public KriteriumBildInfo lochGrossOben9() {
		return new KriteriumFelder("Weiﬂ Mitte oben", weiss, new FeldNummer(3, 2), new FeldNummer(4, 3));
	}

	static public KriteriumBildInfo lochGrossUnten3568() {
		return new KriteriumFelder("Weiﬂ Mitte unten", weissAb80, new FeldNummer(3, 4), new FeldNummer(4, 5));
	}

	static public KriteriumBildInfo lochHalbGrossOben2() {
		return new KriteriumFelder("Weiﬂ Mitte oben", weiss, new FeldNummer(3, 2), new FeldNummer(4, 2));
	}
	...
	static public KriteriumBildInfo ausgangLinksOben14() {
		return new KriteriumFelder("Weiﬂ Links oben", weiss, new FeldNummer(1, 1), new FeldNummer(2, 1));
	}

	static public KriteriumBildInfo ausgangLinksUnten1() {
		return new KriteriumFelder("Weiﬂ Links unten", weiss, new FeldNummer(1, 3), new FeldNummer(3, 6));
	}

	static public KriteriumBildInfo ausgangLinks2() {
		return new KriteriumFelder("Weiﬂ Links oben", weiss, new FeldNummer[] { new FeldNummer(1, 3),
				new FeldNummer(2, 3), new FeldNummer(1, 4) });
	}

	static public KriteriumBildInfo ausgangLinks3() {
		return new KriteriumFelder("Weiﬂ Links Mitte", weissAb90, new FeldNummer(1, 3), new FeldNummer(2, 4));
	}

	static public KriteriumBildInfo ausgangLinksUnten4() {
		return new KriteriumFelder("Weiﬂ Links Unten", weiss, new FeldNummer(1, 6), new FeldNummer(3, 6));
	}

	static public KriteriumBildInfo ausgangLinks5() {
		return new KriteriumFelder("Weiﬂ Links", weissAb70, new FeldNummer(1, 4), new FeldNummer(2, 4));
	}

	static public KriteriumBildInfo ausgangLinks7() {
		return new KriteriumFelder("Weiﬂ Links", weiss, new FeldNummer[] { new FeldNummer(1, 2), new FeldNummer(2, 2),
				new FeldNummer(3, 2), new FeldNummer(1, 3), new FeldNummer(1, 4), new FeldNummer(1, 5),
				new FeldNummer(1, 6) });
	}

	static public KriteriumBildInfo ausgangLinks8() {
		return new KriteriumFelder("Weiﬂ Links", weissAb70, new FeldNummer[] { new FeldNummer(1, 3) });
	}

	static public KriteriumBildInfo ausgangLinks9() {
		return new KriteriumFelder("Weiﬂ Links", weissPunkt50, new FeldNummer(1, 4), new FeldNummer(1, 5));
	}

	static public KriteriumBildInfo ausgangRechts7() {
		return new KriteriumFelder("Weiﬂ Rechts", weiss, new FeldNummer(5, 4), new FeldNummer(6, 6));
	}

	static public KriteriumBildInfo ausgangRechtsOben4() {
		return new KriteriumFelder("Weiﬂ Rechts Oben", weissAb80, new FeldNummer(6, 1), new FeldNummer(6, 3));
	}

	static public KriteriumBildInfo ausgangRechtsOben5() {
		return new KriteriumFelder("Weiﬂ Rechts Oben", weissAb70, new FeldNummer(5, 2), new FeldNummer(6, 2));
	}

	static public KriteriumBildInfo ausgangRechtsOben6() {
		return new KriteriumFelder("Weiﬂ Rechts Oben", weissPunkt50, new FeldNummer(5, 2), new FeldNummer(6, 2));
	}

	static public KriteriumBildInfo ausgangRechtsUnten4() {
		return new KriteriumFelder("Weiﬂ Rechts Unten", weissAb80, new FeldNummer[] { new FeldNummer(6, 6) });
	}

	static public KriteriumBildInfo ausgangRechtsMitte38() {
		return new KriteriumFelder("Weiﬂ Rechts Mitte", weissAb70, new FeldNummer(6, 3), new FeldNummer(6, 3));
	}

	static public KriteriumBildInfo ausgangRechtsUnten2() {
		return new KriteriumFelder("Weiﬂ Rechts unten", weiss, new FeldNummer[] { new FeldNummer(6, 4),
