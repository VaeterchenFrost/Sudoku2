...
class KriteriumFelder implements KriteriumBildInfo {
	 ...
	 * 			ist das Kriterium zu 0 Prozent erf�llt, also nicht erf�llt.
	 * @param erfuellung0Max Bei diesem Wert, der gr��er als der Sollwert ist, 
	 * 			ist das Kriterium zu 0 Prozent erf�llt, also nicht erf�llt.
	 * @return Erf�llungsgrad des Sollwertes durch den Istwert in Prozent
	 */
