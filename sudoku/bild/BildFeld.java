...
class BildFeld {
	 ...
	 * @return Das neue zu Rechteck zentrisch liegende gr��ere bzw. kleinere Rechteck 
	 * 				Wenn das gewollte Rechteck eine negative L�nge bek�me, so wird null zur�ckgegeben.
	 */
	 ...
	 * 			Dieses Zentrum ist der Bereich des feldRechtecks, in dem eine Zahl stehen k�nnte.
	 */
	...
	/**
	 * @param linien Jede Linie sortiert nach Strichl�nge: Auf Index0 der l�ngste Strich
	 * @param linienLaenge L�nge einer jeden Linie
	...
	static private Kanten gibZahlBereich(ArrayList<StricheEinerLinie> linien, int linienLaenge) {
		...
		// }
		// System.out.println(String.format("gibZahlBereich %s: nLinien=%d Linien-L�nge=%d",
		...
		// if (istTestAnzeige){
		// System.out.println(String.format("gibZahlBereich: Linien-L�nge=%d %s", linienLaenge, kanten));
		// }
		return kanten;
	}
	...
	/**
	 * Die Bereiche, in die das ZahlRechteck f�r die Decodierung aufgeteilt ist.
	 */
	private ZahlBereiche zahlBereiche;
	/**
	 * Die Wahrscheinlichkeit f�r jede der Zahlen 1 bis 9 in Prozent.
	 * Auf Index 0 steht die Zahl mit der gr��ten Wahrscheinlichkeit, auch null. 
	 */
	...
	/**
	 * Setzt auf der Basis des Feldrechtecks das Zahlenrechteck. Au�erdem die ZahlBereiche und SchwarzAnteile.
	 * @param image
